...
async def on_startup():
    logger.info("🤖 Карьерный советник v3.0 запускается...")

    try:
        # Инициализируем базу данных
        logger.info("🗄️ Инициализация базы данных SQLite...")
        # db_service уже автоматически инициализируется при импорте
...
async def on_shutdown():
    ...
    try:
        # Создаем резервную копию базы данных при выключении
